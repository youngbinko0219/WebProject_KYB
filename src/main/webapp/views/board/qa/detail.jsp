...
<body>
	<div class="container my-4">
		...
		<div class="d-flex justify-content-end">
			<c:if
				...
				<a
					href="${pageContext.request.contextPath}/qaboard/edit?id=${post.id}"
				...
				<c:forEach var="comment" items="${comments}">
					<li class="list-group-item">
						<form id="comment-form-${comment.commentId}" method="post"
							action="${pageContext.request.contextPath}/comment/updateQaboard"
							...
							<div class="comment-actions">
								<c:if
									...
									<a
										href="${pageContext.request.contextPath}/comment/deleteQaboard?commentId=${comment.commentId}"
	...
	<c:if test="${sessionScope.userId != null}">
		<form action="${pageContext.request.contextPath}/comment/addQaboard"
	...
	<script>
        ...
        if (deleteButton) {
            deleteButton.addEventListener("click", function(event) {
                ...
                if (isConfirmed) {
                    window.location.href = "${pageContext.request.contextPath}/qaboard/delete?id=${post.id}";
                }
            });
        }
	</script>
