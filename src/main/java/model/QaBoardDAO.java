...
public class QaBoardDAO {
	...
	public List<QaBoardDTO> searchPostsByTitle(String query) {
		List<QaBoardDTO> results = new ArrayList<>();
		String sql = "SELECT * FROM qaboard WHERE title LIKE ?";
	...
	public List<QaBoardDTO> searchPostsByContent(String query) {
		List<QaBoardDTO> results = new ArrayList<>();
		String sql = "SELECT * FROM qaboard WHERE content LIKE ?";
